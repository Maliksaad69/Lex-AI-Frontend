...
export const NavbarButton = ({
  ...
  const baseStyles =
    "px-4 py-1 rounded-md bg-white button bg-white text-black text-sm font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center";
