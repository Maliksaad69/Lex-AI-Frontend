    ...
    <div className="w-full" {...getRootProps()}>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center">
          <p className="relative z-20 font-sans text-sm font-bold text-neutral-700 dark:text-neutral-300 sm:text-base">
            Upload file
          </p>
          <p className="relative z-20 mt-2 font-sans text-sm font-normal text-neutral-400 dark:text-neutral-400 sm:text-base">
                ...
                >
                  <div className="flex w-full items-center justify-between gap-4">
                    <motion.p
                      ...
                      animate={{ opacity: 1 }}
                      layout
                      className="max-w-[120px] truncate text-sm text-neutral-700 dark:text-neutral-300 sm:max-w-xs sm:text-base"
                    >
                      {file.name}
                    </motion.p>
                    <motion.p
